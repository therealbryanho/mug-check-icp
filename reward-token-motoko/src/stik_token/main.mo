...
actor class Ledger(init : {
  ...
  private stable var max_supply : Nat = 10_000_000_000_000_000_000; //100 billion max supply
  ...
  public shared({ caller }) func icrc1_mint({
      secret : Text;
  ...
  public query func icrc1_max_supply() : async Nat {
    max_supply
  };
  ...
  public query func icrc1_metadata() : async [(Text, Value)] {
    [
      ...
      ("icrc1:max_supply", #Nat(max_supply)),
