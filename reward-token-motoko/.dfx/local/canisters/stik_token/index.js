...
import { idlFactory } from './stik_token.did.js';
export { idlFactory } from './stik_token.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_STIK_TOKEN;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./stik_token.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the stik_token canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./stik_token.did.js")._SERVICE>}
 */
export const stik_token = createActor(canisterId);
